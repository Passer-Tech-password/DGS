...
const demoCartItems = [
  ...
  },
  {
    ...
    productImage: 'https://images.unsplash.com/photo-1517336714731-489679fd66a8?w=300',
    price: 1450000,
    quantity: 1,
  },
  {
    ...
    productImage: 'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?w=300',
    price: 350000,
    quantity: 1,
  },
];
...
export default function CartPage() {
  const { cart, removeFromCart, updateCartQuantity, clearCart, toggleWishlist, wishlist } = useStore();
  ...
  const items = useDemoData ? demoCartItems : cart;
                    ...
                    <div key={item.productId} className="grid grid-cols-12 gap-4 px-6 py-5 items-center">
                      ...
                      <div className="col-span-2 flex items-center justify-center">
                        <div className="flex items-center border border-gray-700 rounded-md overflow-hidden">
                          <button
                            onClick={() => isHydrated && updateCartQuantity(item.productId, Math.max(1, item.quantity - 1))}
